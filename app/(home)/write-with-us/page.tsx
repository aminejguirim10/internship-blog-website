...
const WriteWithUsPage = () => {
  //TODO: IF user is loggeed and editor in, show the form to write an article
  // in other case it will be the page of application to be an editor
  return (
    <div className="py-4">
